...
<section class="banner">
    <div class="container">
        <div class="banner__inner">
            <h1 class="banner__title"><?php echo CFS()->get('banner_title'); ?></h1>
            <div class="banner__subtitle"><?php echo CFS()->get('banner_subtitle'); ?></div>
    ...
    <div class="container">
        <div class="advantage__inner">
            ...
            <div class="advantage__items">
                <?php
                $advantage_items = CFS()->get('advantage_items');
                foreach ($advantage_items as $item) :
                    ?>
                    <div class="advantage__item">
                        <div class="advantage__item-img"><img src="<?php echo $item['item_image']; ?>" alt=""></div>
                        <div class="advantage__item-text"><?php echo $item['item_text']; ?></div>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="clients__inner">
            ...
            <div class="clients__items">
                <div class="clients__path clients__path_1">
                    <div class="clients__item wow fadeIn" data-wow-delay="0.1s"><img src="<?php echo get_template_directory_uri()?>/img/client-1.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.2s"><img src="<?php echo get_template_directory_uri()?>/img/client-2.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.6s"><img src="<?php echo get_template_directory_uri()?>/img/client-6.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.7s"><img src="<?php echo get_template_directory_uri()?>/img/client-7.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1.1s"><img src="<?php echo get_template_directory_uri()?>/img/client-11.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1.2s"><img src="<?php echo get_template_directory_uri()?>/img/client-12.png" alt="Клиент"></div>
                </div>
                <div class="clients__path clients__path_2">
                    <div class="clients__item wow fadeIn" data-wow-delay="0.3s"><img src="<?php echo get_template_directory_uri()?>/img/client-3.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.4s"><img src="<?php echo get_template_directory_uri()?>/img/client-4.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.5s"><img src="<?php echo get_template_directory_uri()?>/img/client-5.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.8s"><img src="<?php echo get_template_directory_uri()?>/img/client-8.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="0.9s"><img src="<?php echo get_template_directory_uri()?>/img/client-9.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1s"><img src="<?php echo get_template_directory_uri()?>/img/client-10.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1.3s"><img src="<?php echo get_template_directory_uri()?>/img/client-13.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1.4s"><img src="<?php echo get_template_directory_uri()?>/img/client-14.png" alt="Клиент"></div>
                    <div class="clients__item wow fadeIn" data-wow-delay="1.5s"><img src="<?php echo get_template_directory_uri()?>/img/client-15.png" alt="Клиент"></div>
                </div>
            </div>
